...
if(
    ...
    if (verif_mdp($psw)) {
        ...
        $sql3 = "SELECT COUNT(*) AS count FROM particular WHERE mail = '$mail'";
        ...
        if ($result) {
            ...
            sendMessage("Veuillez remplir correctement les champs et acceptez les conditions d'utilisation", "failed", "../../view/particular/create_particular");
}
