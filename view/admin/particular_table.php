        ...
        if (isset($_SESSION["id"])) {
            ...
            $users = $stmt->fetchAll(PDO::FETCH_ASSOC);
                ...
                foreach ($users as $user ) {
                    ...
                    $table .="<td> <a class='none' data-toggle='tooltip' data-placement='top' title='VieW' href='view/admin/read_admin_particular?id=$user[id_user]'>👁️</a> </td>"; 
                    ...
                    $table .="<td> <a class='none bomb' data-bs-toggle='modal' data-bs-target='#validation_delete' data-link='controller//admin/delete_ctrl_particular.php?id=$user[id_user]' data-placement='top' href='' title='Supprimer un utilisateur'>a</a> </td>"; 
                    $table .="<tr>";
                }
                echo $table;
            }
