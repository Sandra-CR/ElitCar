...
<main class="col-12 g-0">
    <div class="container-professional d-flex flex-wrap mt-4 col-12 g-0">
        <div class="container-pro-create col-12 col-xl-7 ">
            <div class="container-pro-center col-8 mx-auto">
                <div class="container-pro-title  ">
                    <h1>S’inscrire en tant que agence de location de voiture</h1>
                </div>
                <div class="container-pro-subtitle my-1">
                ...
                <div class="container-btn-create col-12">
                    <a target="_self" class="col-8" href="view/professional/create_professional"><button class="btn btn-warning-pro-1 my-2">S'inscrire</button></a>
                </div>
            </div>
        </div>
        <div class="container-pro-img d-flex col-12 col-xl-5 ">
            <div class="container-pro-img-1 col-8 d-flex d-xl-flex col-xl-8 mx-auto"></div>
        </div>
    </div>

    <div class="container-professional-2 row col-12 g-0 ">
    
        <div class="container-main-choose-sub rounded h-75 col-10 my-5 col-xl-10 mx-auto">

            <div class="container-main-choose-sub-title h-25 col-10 col-xl-7 mt-5">
                <h2>Faites augmenter votre chiffre d’affaire d’une manière significative</h2>
            </div>

            <div class="container-main-choose-sub-card h-75 col-12">

                <div class="container-main-choose-sub-card-1 col-10 col-md-8 col-lg-6 col-xl-3 h-75  ">

                    <div class="container-main-choose-sub-card-title mt-4">

                        <p>Vous avez moins de 10 voitures</p>

                    </div>
                    <div class="container-main-choose-sub-card-price mt-3">

                        <h5>12000 CFA par an</h5>
                    </div>

                    <div class="container-main-choose-sub-card-btn col-8 h-100 ">

                        <a target="_self" class="col-8 col-xl-10" href="view/professional/create_professional">

                            <button class="btn btn-warning-pro-2 col-6 my-3 mt-xl-5">S'inscrire</button>
                        </a>
                ...
                <div class="container-main-choose-sub-card-2 col-10 col-md-8 col-md-8 col-lg-6 col-xl-3 h-75 ">
                ...
                <div class="container-main-choose-sub-card-3 col-10 col-md-8 col-md-8 col-lg-6 col-xl-3 h-75 ">
    ...
    <div class="container-professional-3 row col-12 g-0 "></div>
<!-- Section FAQ -->
