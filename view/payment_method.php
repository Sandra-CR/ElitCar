                    ...
                    <div class="col-md-6">
                        <div class="card text-center" style="padding: 40px!important;">
                            <div class="card-body d-flex justify-content-center align-items-center" style="display:flex;flex-direction:column;">
                                ...
                                <img src="../img/credit-card 1.png" alt="Card Icon" class="icon-card mb-3 col-md-2">
                                ...
                                <a href="#" class="btn" style="background-color:#FFAA00;color:white;font-weight:700;font-size:16px;height:100%;max-width:99%;padding: 15px 0 15px 0">Trouver un véhicule</a>
                            </div>
                        </div>
                    </div>
                </div>
